...
>
  ...
  <div className="headings *:text-center *:leading-4">
    ...
    <p className="text-sm font-semibold text-[#434955] mt-3">{user.profession}</p>
  </div>
  ...
  />
  <Link to="/edit-profile" className="mt-2 mb-4 px-4 py-2 bg-blue-400 text-white font-bold rounded-lg">
        Edit Profile
      </Link>
</div>
